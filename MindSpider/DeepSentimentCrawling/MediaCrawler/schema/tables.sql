...
(
    ...
    `source_keyword`   varchar(500) DEFAULT NULL COMMENT '搜索关键词',
    PRIMARY KEY (`id`),
...
-- 注意: source_keyword 字段已在上面的 CREATE TABLE 语句中定义，无需再次添加
...
CREATE TABLE `zhihu_content` (
    ...
    `source_keyword` varchar(500) DEFAULT NULL COMMENT '来源关键词',
    `user_id` varchar(64) NOT NULL COMMENT '用户ID',
